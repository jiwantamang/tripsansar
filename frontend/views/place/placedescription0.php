  ...
  <div class="placeimage">
    ...
    <?php
        ...
        foreach($images as $image){
            echo Html::img(Yii::$app->urlManagerBackend->baseUrl.'/upload/image/'.$image['image_name']);
        }
              ...
              <div class="row no-margin">
                    ...
                    <?php 
                      ...
                      foreach($hotels_id as $hotel_id){
                          ...
                          <tr>
                              <td><img src="/<?php echo Yii::$app->name; ?>/hotel/upload/hotel_thumbnail/<?= $hotel_profile->image ?>" class="img-thumbnail hotel-img-thumbnail" ></td>
                              <td>
                                  <ul>
